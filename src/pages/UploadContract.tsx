...
function UploadContract() {
  ...
  const [statusMessage, setStatusMessage] = useState('Validate Contract');
  ...
  useEffect(() => {
    const messages = [
      ...
      'Parsing Contract...',
      'Identifying Contract Context...',
      'Finding Relevant Laws...',
      'Discovering Related Cases...',
    ...
    if (loading) {
      ...
      setStatusMessage('Validate Contract');
    }
  }, [loading]);
